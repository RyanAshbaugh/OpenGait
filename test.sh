# # **************** For CASIA-B ****************
# # Baseline
CUDA_VISIBLE_DEVICES=5,6 python -m torch.distributed.launch --nproc_per_node=2 opengait/main.py --cfgs ./config/baseline/baseline_BRIAR_1_1.1_2.yaml --phase test
